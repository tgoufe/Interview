...
#### 8.["1", "2", "3"].map(parseInt)的结果是什么？parseInt("6.022e23", 10) 和 parseInt(" 131", 2)的结果是什么？
...
```
### 10.Cookie LocalStorge SessionStorge 区别
```
  数据传递:
...
### 12.Js继承有多少种方式？原理是什么？有什么缺点？
```markdown
   
```

### 13.怎么理解js作用域？什么是作用域链？怎么理解闭包？
```markdown
